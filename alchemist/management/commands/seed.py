    ...
    def handle(self, *args, **options):
        ...
        effects_seed = [
            ...
            },
            {
                "name": "Defense Boost",
                "lvls": {
                    1: "+1 potion bonus to all defenses until the end of your next turn.",
                    2: "+1 potion bonus to all defenses until the end of the encounter.",
                    3: "+2 potion bonus to all defenses until the end of your next turn.",
                    4: "+2 potion bonus to all defenses until the end of the encounter.",
                    5: "+3 potion bonus to all defenses until the end of your next turn.",
                    6: "+3 potion bonus to all defenses until the end of the encounter.",
                    7: "+4 potion bonus to all defenses until the end of your next turn.",
                    8: "+4 potion bonus to all defenses until the end of the encounter.",
                    9: "+5 potion bonus to all defenses until the end of your next turn.",
                    10: "+5 potion bonus to all defenses until the end of the encounter, and gain a permanent +1 bonus to a defense of your choice.",
                },
                "reagents": [""],
            },
            {
            ...
            },
            {
                ...
                "lvls": {
                    ...
                    8: "Gain a +4 potion bonus to your speed until the end of the encounter.",
                    9: "Gain a +5 potion bonus to your speed until the end of the encounter.",
                    10: "Gain a +5 potion bonus to your speed until the end of the encounter, and a permanent +1 bonus to your speed.",
                },
                "reagents": [""],
            },
            {
