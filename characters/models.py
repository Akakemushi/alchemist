...
class Character(models.Model):
    ...
    items = models.ManyToManyField("item.Item", through="item.CharacterItem", related_name="characters", blank=True)
    ...
    class Meta:
        constraints = [models.UniqueConstraint(fields=["campaign", "slug"], name="unique_slug_per_campaign")]
